...
class Model:
    ...
    def eliminar(self,id):
        ...
        data=resultado[0]
        eliminador={'curso': data[1],'profesor':data[5],'grupo': data[6]}
        cur2=self.mysql.connection.cursor()
        query="DELETE FROM horarios WHERE curso=%(curso)s and grupo=%(grupo)s and profesor=%(profesor)s"
        cur2.execute(query,eliminador)
        self.mysql.connection.commit()#se ejecuto la consulta

    def examinar(self,horasi,horasf):
        cur=self.mysql.connection.cursor()
        tup=[]
        tup2=[]
        contenido={}
        ...
        hor = ('07:00-07:50','07:50-08:40','08:50-09:40','09:40-10:30','10:40-11:30','11:30-12:20','12:20-13:10','13:10-14:00', '14:00-14:50','14:50-15:40','15:50-16:40','16:40-17:30','17:40-18:30','18:30-19:20','19:30-20:20')
        return tup,dia,hor
